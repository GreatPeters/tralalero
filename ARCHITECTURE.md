...
- `ForwardEnemyMovementSetup.Configure` remains an internal repair API for the five default prefab components and the trigger prefab. It is not exposed in the map-production menu and does not save an open scene.
