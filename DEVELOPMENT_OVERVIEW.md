...
2026-09-10 표현·장비 후속: SR18 적27명을25% 축소하고 두 군집의 모델/간격을 바꿨다. 몸·머리 시선, 운반 상체 레이어, 발 높이 보정, 가드 총구/발사 Trail과 뚱보의 짧은 던지기를 연결했다. 가로등은 기존4개까지 포함해12개의 접촉/탄환 반응이 일치한다. 두 노량진 씬에 보석 장비24종·장착 효과, 오프닝 UI/영상·넘기기, 개조소 스타일 사망 UI를 적용했다. 고속도로 적3종은 TRELLIS2로 FBX/텍스처/시각 프리팹을 생성했으며 리깅 전 메시다.20회 성장 검증과 최종 결과는 [작업 기록](map-concepts/sr18-presentation-progression-2026-09-10/README.md)을 따른다. 아래 기록은 이전 작업의 상태를 보존한다.
