...
are Normal, FatMan is Elite, and Woman is Boss. Per-stage damage and health come
from the tier growth values documented in `game-data-workbook.md`, not from
placement order, a scene-instance tier override, or an enemy-specific weight.
