...
topic="bonus-ring-variants-2026-09-19"
...
gallery=root/"tmp/image-previews/bonus-gallery-2026-09-19/ring-variants"
...
template=template.replace("보너스 시안 모아보기","7번 오픈 링 · 베리에이션 10가지")
template=template.replace("이미지를 눌러 크게 보세요. 원본 크기 보기와 PNG 저장도 가능합니다.","선택하신 7번 오픈 링 코어에서 확장한 10가지 형태입니다. 이미지를 눌러 게임 안 모습·형태·획득 연출을 크게 비교하세요.")
