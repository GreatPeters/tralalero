...
public static class CombatFeedbackPrefs
{
    ...
    private const string FilePath = "tmp/combat-feedback-2026-09-14/before/prefs-before.tsv";
    public static object Begin()
    {
        ...
        for (int i = 1; i <= 10; i++) Add("upgrade_lv_" + i, "int");
