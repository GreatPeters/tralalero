...
var body=player.GetComponent<Rigidbody>();var camera=player.GetComponentsInChildren<Camera>(true).Single(c=>c.name=="MapTool_Camera");
string folder="tmp/image-previews/sr18-slope-motion-2026-09-05/"+System.DateTime.UtcNow.ToString("HHmmss");System.IO.Directory.CreateDirectory(folder);
string reportPath="map-concepts/sr18-slope-spots-2026-09-05/playmode-probe.json";
