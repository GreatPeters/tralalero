...
public static class PrototypeSyncedCrateSurface
{
 public static string Main()
 {
  string folder="map-concepts/synced-crate-throw-2026-09-20/prototype-surface";Directory.CreateDirectory(folder);
  ...
  var skin=go.GetComponentInChildren<SkinnedMeshRenderer>(true);var clean=new Material(skin.sharedMaterial);clean.shader=Shader.Find("FlatKit/Stylized Surface");skin.sharedMaterial=clean;var weights=skin.sharedMesh.boneWeights;var mesh=new Mesh();
