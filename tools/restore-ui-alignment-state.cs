...
const string folder="tmp/backups/ui-text-alignment-2026-09-17";
...
System.IO.File.WriteAllText("map-concepts/ui-text-alignment-2026-09-17/restoration.txt",records+" preference records restored exactly from today's fresh snapshot. Coin="+PlayerPrefs.GetInt("coin")+". SR18 open in Edit Mode; Game View size unchanged.");
