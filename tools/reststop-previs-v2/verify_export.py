...
bpy.ops.wm.read_factory_settings(use_empty=True);bpy.ops.import_scene.gltf(filepath=str(OUT/'reststop-v2-environment.glb'))
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'reststop-v2-environment-reimport.blend'),compress=True)
