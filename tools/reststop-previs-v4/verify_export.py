...
OUT=Path.cwd()/'outputs/reststop-blender-v4-2026-09-23'
bpy.ops.wm.read_factory_settings(use_empty=True);bpy.ops.import_scene.gltf(filepath=str(OUT/'reststop-v4-environment.glb'))
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'reststop-v4-environment-reimport.blend'),compress=True)
